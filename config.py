...
# ── DCA entry structure ────────────────────────────────────────────────── #
DCA_DROP_STEP_PCT       = 0.5   # trigger a new buy every X% drop from DCA_HIGH_LOOKBACK_CANDLES / 12 high
...
DCA_HIGH_LOOKBACK_CANDLES = 12  # 12 × 5m = 1h  |  288 = 24h  |  72 = 6h - max 24 hrs
